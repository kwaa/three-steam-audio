...
<Tabs syncKey="api">
  <TabItem label="Three.js">
    ...
    // ---cut-start---
    declare const roomGeometry: BufferGeometry
    declare const room: Object3D
    // ---cut-end---
...
<Tabs syncKey="api">
  <TabItem label="Three.js">
    ...
    // ---cut-start---
    declare const doorGeometry: BufferGeometry
    declare const door: Object3D & { position: Mesh['position'] }
    // ---cut-end---
...
<Tabs syncKey="api">
  <TabItem label="Three.js">
    ...
    // ---cut-start---
    declare const handle: ReturnType<typeof world.scene.addStaticMesh>
    // ---cut-end---
    handle.dispose()
    world.scene.commit()
    ```
